...
double area=0.5, constE, nu, t, delt, ShrinkCoeffMD, ShrinkCoeffCD, rho, DiffusionCoeff, Dissipation, cdamp1, cdamp2, sourcetime, SourceZ, LameFirst, LameSecond; // area of the canonical triangle
